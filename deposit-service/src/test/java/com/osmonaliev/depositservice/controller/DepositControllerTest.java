...
import com.javastart.depositservice.config.H2DatabaseConfig;
...
@SpringBootTest(classes = {DepositApplication.class, H2DatabaseConfig.class})
public class DepositControllerTest {
    ...
    public void createDeposit() throws Exception {
        ...
        List<Deposit> deposits = depositRepository.findDepositsByEmail("Email");
